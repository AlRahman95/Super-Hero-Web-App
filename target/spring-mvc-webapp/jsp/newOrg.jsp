        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 body">
                    <h2>Add New Super Organization </h2><hr>
                    <form class="form-horizontal" role="form" method="POST" action="newOrg">

                        <div class="form-group">
                            <label for="add-org-name" class="col-sm-2 control-label">Name:</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <label for="add-org-location" class="col-sm-2 control-label">Location:</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <label for="add-org-phone" class="col-md-2 control-label">Phone:</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label for="add-org-email" class="col-md-2 control-label">Email:</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea type="text" class="form-control" rows="3" name="description" placeholder="Description of organization"></textarea>
                            </div>
                        </div>
