        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 body">
                    <h2>Add New Super Hero/Villain</h2><hr>
                    <form class="form-horizontal" role="form" method="POST" action="newSuper">

                        <div class="form-group">
                            <label for="add-hero-name" class="col-sm-2 control-label">Hero/Villain:</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <label for="add-height" class="col-md-2 control-label">Height</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <label for="add-weight" class="col-md-2 control-label">Weight:</label>
                            <div class="col-md-8">
                        ...
                        <div class="form-group">
                            <label for="add-power" class="col-md-2 control-label">Power:</label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea type="text" class="form-control" rows="3" name="description" placeholder="Description of power"></textarea>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-sm-8 body">
                    <h2>Super Hero/Villain Summary</h2>
